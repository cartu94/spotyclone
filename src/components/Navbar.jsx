...
export default function Navbar() {
  return (
    <div>
      <nav className="font-montserrat text-sm font-bold flex justify-between items-center bg-background px-2 w-full sm:px-5 py-3">
        <div className="flex justify-center items-center gap-2">
          <button className="hidden sm:hidden xl:flex justify-center items-center bg-black rounded-full h-8 w-8">
            <Icons.SimpleArrowLeft classes="text-inactive text-lg" />
          </button>
          <button className="hidden sm:hidden xl:flex justify-center items-center bg-black rounded-full h-8 w-8">
            <Icons.SimpleArrowRight classes="text-inactive text-lg" />
          </button>
          <div
        ...
        <div className="flex justify-center items-center gap-2">
          ...
          <button className="inline-flex items-center justify-center h-8 w-8 bg-black text-active rounded-full xl:hover:scale-110 xl:duration-75">
            <Icons.Notification classes="text-inactive text-lg" />
          </button>
